...
Note Type			 | This changes the note symbol (whole note, half note, or quarter note) in order to match visibility preference.<br><br>This does not affect rate of play at all. | <img src="images/20quarter.png" alt="Quarter Notes" width="320" height="252"><br><img src="images/21half.png" alt="Half Notes" width="320" height="252"><br><img src="images/22whole.png" alt="Whole Notes" width="320" height="252">
